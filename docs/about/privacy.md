...
- 访问我们的网站 [zyc.ai](https://multimolecule.zyc.ai) 或任何链接到本隐私声明的我们的网站时
...
如果您仍有任何问题或关注，请通过[privacy@zyc.ai](mailto:privacy@zyc.ai)与我们联系。
...
!!! question "您如何行使您的权利？"
    ...
    行使您的权利的最简单方式是通过[privacy@zyc.ai](mailto:privacy@zyc.ai)与我们联系。
...
<!-- 关于我们如何使用此类技术以及您如何拒绝某些cookies的具体信息，请查看我们的Cookie声明：multimolecule.zyc.ai/about/cookie。 -->
